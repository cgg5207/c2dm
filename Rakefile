...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = "c2dm"
  gem.homepage = "https://github.com/favoritemedium/c2dm"
  gem.license = "MIT"
  ...
  gem.email = "yasith@favoritemedium.com"
  gem.authors = ["Yasith Fernando", "Amro Mousa"]
  # Include your dependencies below. Runtime dependencies are required when using your gem,
  # and development dependencies are only needed for development (ie running rake tasks, tests, etc)
  #  gem.add_runtime_dependency 'jabber4r', '> 0.1'
   gem.add_runtime_dependency 'httparty', '0.6.1'
   gem.add_runtime_dependency 'typhoeus', '0.2.4'
